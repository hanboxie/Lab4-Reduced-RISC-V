...
VL_INLINE_OPT QData Vtop___024root___change_request_1(Vtop___024root* vlSelf) {
    ...
    __req |= ((vlSelf->top__DOT__EQ ^ vlSelf->__Vchglast__TOP__top__DOT__EQ));
    VL_DEBUG_IF( if(__req && ((vlSelf->top__DOT__EQ ^ vlSelf->__Vchglast__TOP__top__DOT__EQ))) VL_DBG_MSGF("        CHANGE: top.sv:27: top.EQ\n"); );
    // Final
    vlSelf->__Vchglast__TOP__top__DOT__EQ = vlSelf->top__DOT__EQ;
    return __req;
}
